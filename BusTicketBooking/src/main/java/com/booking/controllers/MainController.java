...
import com.booking.repositories.CityRepository;
import com.booking.repositories.PassengerRespository;
import com.booking.services.BusService;
import com.booking.services.CityService;
...
public class MainController {
    ...
    public String deleteGet(@PathVariable("number") int numberPassenger) {
        passengerRespository.deleteAllByNumberPassenger(numberPassenger);
